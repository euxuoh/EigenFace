...
public class Test {
	...
	public static void main(String[] args) {
		...
		HttpRequests httpRequests = new HttpRequests(
				"ebe89cb1d461f5e48c782aa47549d52f",
				"RwEsl8L7pjLW9cgfEtTa5X2UBJjKr1cF", true, true);
		...
		try {
			...
			System.out.println(result.getJSONArray("face").getJSONObject(0)
			...
			// info/get_face
			System.out.println("\ninfo/get_app");
			System.out.println(httpRequests.infoGetFace(new PostParameters()
					.setFaceId(result.getJSONArray("face").getJSONObject(0)
							.getString("face_id"))));
			...
			// info/get_image
			System.out.println("\ninfo/get_image");
			System.out.println(httpRequests.infoGetImage(new PostParameters()
					.setImgId(result.getString("img_id"))));
			...
			System.out.println("\nperson/remove_face");
			System.out.println(httpRequests
					.personRemoveFace(new PostParameters().setPersonName(
							"person_0").setFaceId(
							result.getJSONArray("face").getJSONObject(0)
									.getString("face_id"))));
			...
			// faceset/delete
			System.out.println("\nfaceset/delete");
			System.out.println(httpRequests.facesetDelete(new PostParameters()
